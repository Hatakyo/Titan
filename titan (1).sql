...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2021 at 02:22 PM
...
(7, 2, 1, 'Phan Quang Linh', 'Hà Nội', 333881198, 'Ships', 'ACE RỰC LỬA', 1, 10200000);
...
--
ALTER TABLE `sanpham`
  MODIFY `id_sp` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
